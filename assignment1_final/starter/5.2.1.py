...
def render_torus_gif(image_size=256, num_samples=100, num_frames=60, duration=15, output_path="images/torus_gif_5.2.1.gif"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_path", type=str, default="images/torus_gif_5.2.1.gif")
