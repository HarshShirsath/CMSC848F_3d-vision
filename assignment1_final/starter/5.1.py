...
def load_rgbd_data(path="data/rgbd_data.pkl", image_size=512, duration=200,device = None, output_file="images/360_view_plant2.gif", ):
    ...
    for theta in range(0, 360, 10):
        ...
        rend = renderer(point_cloud3, cameras=cameras)
