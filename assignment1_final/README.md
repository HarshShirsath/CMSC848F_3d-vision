...
TO ACCESS THE FILES:
0.1. RENDERING YOUR FIRST MESH: RUN (assignment1_final/starter/render_mesh.py), RESULT: assignment1_final/images/cow_render.jpg
1. Practicing with Cameras
    1.1. 360-degree Renders:
        RUN (assignment1_final/starter/Cow_render.py)
        RESULT (assignment1_final/images/cow_render.gif)

    1.2. RECREATING THE DOLLY ZOOM:
        RUN (assignment1_final/starter/dolly_zoom.py)
        RESULT (assignment1_final/images/dolly.gif)

2. PRACTICING WITH MESHES

    2.1 Constructing a Tetrahedron:
        RUN (assignment1_final/starter/tetrahedron_mesh.py)
        RESULT (assignment1_final/images/tetrahedron_rotation.gif)
    
    2.2.Constructing a Cube :
        RUN (assignment1_final/starter/cube.py)
        RESULT (assignment1_final/images/cube_rotation.gif)

3. RE_TEXTURING A MESH
        RUN (assignment1_final/starter/retexture_cow.py)
        RESULT (assignment1_final/images/cow_retextured_rotation.gif)
        RESULT (assignment1_final/images/cow_textured.jpg)

4. CAMERA TRANSFORMATIONS

    4.1:RUN (assignment1_final/starter/camera_transformation 1_3_4.py)
        RESULT (assignment1_final/images/transform 1.jpg)

    4.2:RUN (assignment1_final/starter/camera_transformation_2.py)
        RESULT (assignment1_final/images/transform 2.jpg)

    4.3:RUN (assignment1_final/starter/camera_transformation 1_3_4.py)
        RESULT (assignment1_final/images/transform 3.jpg)
    
    4.4:RUN (assignment1_final/starter/camera_transformation 1_3_4.py)
        RESULT (assignment1_final/images/transform 4.jpg)
    
5. RENDERING GENERIC 3D REPRESENTATIONS

    5.0:RUN (assignment1_final/starter/render_generic.py)
        RESULT (assignment1_final/images/bridge.jpg)

    5.1 Rendering Point Clouds from RGB-D Images
        5.1.1: RUN (assignment1_final/starter/5.1.1.py)
        RESULT (assignment1_final/images/plant_1.gif)

        5.1.2: RUN (assignment1_final/starter/5.1.2.py)
        RESULT (assignment1_final/images/plant_2.gif)

        5.1: RUN (assignment1_final/starter/5.1.py)
        RESULT (assignment1_final/images/360_view_plant2.gif)

    5.2. Parametric Functions
        5.2: RUN (assignment1_final/starter/5.2.1.py)
        RESULT (assignment1_final/images/torus_gif_5.2.1.gif)

        5.1: RUN (assignment1_final/starter/5.2.py)
        RESULT (assignment1_final/images/torus_gif_5.2.2.gif)

    5.3. Implicit Surfaces
        RUN (assignment1_final/starter/5.3.py)
        RESULT (assignment1_final/images/torus_5.3.gif)
